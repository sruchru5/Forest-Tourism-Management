...
b1=Button(root,borderwidth=2, relief="flat",text="VIEW PLACES", font="verdana 15", bg="red", fg="white",command=view_place)
b1.place(height=150,width=200,x=930,y=50)

b2=Button(root,borderwidth=2, relief="flat",text="BOOK PLACES", font="verdana 15", bg="red", fg="white",command=book_place)
b2.place(height=150,width=200,x=930,y=280)

b3=Button(root,borderwidth=2, relief="flat",text="LOGOUT", font="verdana 15", bg="red", fg="white",command=logout)
b3.place(height=150,width=200,x=930,y=500)
